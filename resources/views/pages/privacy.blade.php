...
<main class="pt-32 pb-20 px-8 max-w-4xl mx-auto">
    ...
    <div class="space-y-4 text-on-surface-variant">
        ...
        <h2 class="text-xl font-bold mt-6 mb-3">Utilisation des informations</h2>
        <p>Nous utilisons vos informations pour vous fournir nos services, vous contacter et améliorer notre plateforme.</p>
        <h2 class="text-xl font-bold mt-6 mb-3">Protection des données</h2>
